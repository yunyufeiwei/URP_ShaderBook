...
{
    static readonly string RenderTag = "FogWithDepthTexture";               //新建渲染事件的名称
    ...
    Material m_material;
    FogWithDepthTextureVolume volume;

    RenderTargetIdentifier source;

    public FogWithDepthTexturePass(RenderPassEvent passEvent, Shader m_shader)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        volume = stack.GetComponent<FogWithDepthTextureVolume>();
        if (volume == null)
        {
