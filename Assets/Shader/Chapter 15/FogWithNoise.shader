Shader "URP/ShaderBook/Chapter 15/FogWithNoise"
{
    Properties
    {
        ...
        _NosieTex("NoiseTexture",2D) = "white"{}
    ...
    SubShader
    {
        ...
        half4 frag(Varyings i) : SV_Target
        {
            ...
            float  noise = (SAMPLE_TEXTURE2D(_NosieTex,sampler_NosieTex,i.uv + speed).r * 0.5) * _NoiseAmount;
