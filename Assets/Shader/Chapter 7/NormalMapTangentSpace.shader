Shader "URP/ShaderBook/Chapter 7/NormalMapTangentSpace"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert (Attributes v)
            {
                ...
                half3 binormal = cross(normalize(v.normalOS),normalize(v.tangentOS.xyz)) * sign;
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                half3 diffuse = lightColor.rgb * _DiffuseColor.rgb * baseMap.rgb * max(0.0,dot(normalTs,tangentLightDir));
                half3 specular = lightColor.rgb * _SpecularColor.rgb * pow(max(0.0,dot(normalTs,halfDir)),_SpecularPower);
