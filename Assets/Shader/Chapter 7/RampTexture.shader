Shader "URP/ShaderBook/Chapter 7/RampTexture"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert (Attributes v)
            {
                ...
                o.vieDirWS = GetWorldSpaceViewDir(o.positionWS);
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                half3 worldViewDir = normalize(i.vieDirWS);
