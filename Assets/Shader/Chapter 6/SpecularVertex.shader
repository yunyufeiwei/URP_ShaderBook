Shader "URP/ShaderBook/Chapter 6/SpecularVertex"
{
    Properties
    {
        _DiffuseColor("DiffuseColor",Color) = (1,1,1,1)
        _SpecularColor("SpecularColor",Color) = (1,1,1,1)
        [powerSlider(8)]_SpecularPower("SpecularPower",Range(1,50)) = 8
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert (Attributes v)
            {
                ...
                half3 worldNormal = TransformWorldToObjectNormal(v.normalOS.xyz);
                ...
                half4 specular = lightColor * _SpecularColor * pow(saturate(dot(reflectDir,viewDirWS)),_SpecularPower);
