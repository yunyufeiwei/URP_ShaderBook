Shader "URP/Chapter 6/BlinnPhongUseUniversal"
{
    Properties
    {
        _DiffuseColor("DiffuseColor", Color) = (1,1,1,1)
        _SpecularColor("SpecularColor",Color) = (1,1,1,1)
        [PowerSlider(8)]_SpeculsrPower("SpecularPower",Range(1,50)) = 8
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings i) : SV_Target
            {
                ...
                //phong
                half4 specluar = half4(LightingSpecular(lightColor.rgb , worldLightDir , worldNormal , worldViewDir , _SpecularColor , _SpeculsrPower) , 1.0);
